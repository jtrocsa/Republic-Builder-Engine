...
| 5   | O   | S3  | `rough`   | Doorways should read as dynamic entrances, Pokémon-style, with light spilling out.                                                                                                                                                                                                                                                                                                                              | **Deferred to Phase 90B.** Destination named.                                                                                                       |
...
- **→ Phase 90B**: findings 2 and 5, the two art items.
