...
| 5   | O   | S3  | `rough`   | Doorways should read as dynamic entrances, Pokémon-style, with light spilling out.                                                                                                                                                                                                                                                                                                                              | Fixed in Phase 90B (`0079`). Ten doors lit — the eight interiors and the Institute's two — deliberately not all 155 door cells.                     |
