...
| 4 | Decompose `main.js`'s 2470–3328 event-listener block into named, `export`-in-place handler functions | Medium-risk | Explicitly the sanctioned pattern — `export` in place, no physical move out of `main.js` |
