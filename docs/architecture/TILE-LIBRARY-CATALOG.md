...
| **A4 sheet** | 768×720    | 16 cols × 15 rows = 240 tiles | RPG Maker wall/floor _texture_ atlas — flat surfaces (wood, stone, metal, plaster, tile). |
...
| `tile-B-05.png`            | Dense cargo _stacks_ — grouped barrels, crate piles, sack heaps, tarp-covered loads, labelled and stamped shipping crates, sea chests, coiled rope, anchors, nets. Composition pieces rather than single objects; ideal for filling a wharf.                                                                                                                                       | `CANONICAL`  | 2–7     |
...
| sheet                      | contents                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | verdict      | periods |
| -------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------ | ------- |
| `1.png`                    | Open-plan office — cubicle partitions, **desks with beige CRT monitors** (deep chassis, thick bezel, vent grille under a small screen — the four at cols 6–7), filing cabinets, **tall double-door storage cupboards** (0,10), water cooler, photocopier, conference table. **The only era-correct computer in the library for the 1990s**: `2.png` and `3.png` both draw flat panels, which are 2005 at the earliest, so the three sheets cannot share a room. Established by inspection in Phase 101, against this table, which had said only "desks with computers" and could not settle it. | `SUPPORTING` | 9       |
