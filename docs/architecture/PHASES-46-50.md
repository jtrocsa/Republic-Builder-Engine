...
- **47G** — Surface + dead-CSS sweep: fold four near-identical card surfaces (`.manage-content-mission-card`, `.source-pool-row`, `.manage-content-editor-section`, `.manage-content-source-summary-card`) onto `.c-card`/`.c-card--interactive`.
