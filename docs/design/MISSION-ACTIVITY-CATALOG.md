...
carry an activity: a case declares no `sources` at all unless it walks a map — two cases in every three, sixteen of the twenty-four playable and eighteen of the twenty-seven registered — and reaching one from
