# Decision 0015 — Living Caribbean Interactions Pass
...
- Clicking NPCs updates the field notice without re-rendering the whole map.
- The three required evidence records now have distinct interaction gates:
  - Taíno village investigation before the secondary context record.
  - Spanish camp / Columbus point-of-view checkpoint before the Columbus letter.
