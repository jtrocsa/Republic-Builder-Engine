export const ATLANTIC_CROSSROADS_CASE = {
  ...
  centralQuestion:
    "How did contact between Europe, Africa, and the Americas begin to reshape societies on both sides of the Atlantic?",
  entryMessage:
    "Before you trace exchange, establish what already existed. The Caribbean was already home to complex Indigenous communities before European expeditions arrived.",
  objectives: [
  ...
  evidence: [
    {
      ...
      excerpt:
        "Taíno communities had their own language, political organization, arts, ceremonial practices, staple crops, and canoe travel before European contact.",
      whyItMatters:
        "The historical setting did not begin with Europeans. This evidence helps establish what already existed in the Caribbean.",
    ...
    },
    {
      ...
      whyItMatters:
        "This is an account written by an expedition leader for the Spanish monarchy. It is evidence of Columbus’s claims and point of view—not a complete account of Indigenous experience.",
      citation:
        "Christopher Columbus, letter reporting on the 1492 voyage, printed 1493; Library of Congress.",
      sourceUrl:
    ...
    },
    {
      ...
      excerpt:
        "A 1494 printed edition of Columbus’s letter used woodcuts that were largely adapted from Mediterranean settings rather than direct depictions of the Caribbean.",
      whyItMatters:
        "Source analysis includes images. Before using a visual source as evidence, investigate where it came from and how it was made.",
      citation: "Library of Congress, “Columbus’s Voyage and the New World.”",
      sourceUrl:
        "https://www.loc.gov/exhibits/exploring-the-early-americas/columbus-and-the-taino.html",
      prompt:
        "What question should you ask before treating a historical image as a reliable depiction?",
    },
  ],
  sourceCheck: {
    ...
    correct: 1,
    feedback:
      "Correct. The letter was written by Columbus after the voyage for Spain’s rulers. That makes it valuable evidence of European goals and claims, while also limiting what it can tell us about Indigenous experience.",
  },
};
