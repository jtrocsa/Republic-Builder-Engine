export const CHRONICLE_IDENTITY_DEFAULTS = {
  ...
  identity: {
    ...
    subtitle: 'Before entering the field, every Chronicler establishes an identity within the Archive.',
  ...
  registration: {
    ...
    codexBody: 'A field notebook linked to the Archive. It holds current evidence, records your analysis, and transmits your report when the case is complete.',
  ...
  field: {
    ...
    mentorDialogue: 'You made it. Before we enter the historical setting, remember the protocol: observe the moment, interrogate its evidence, and report only what the record can support.',
    interaction: 'Speak',
