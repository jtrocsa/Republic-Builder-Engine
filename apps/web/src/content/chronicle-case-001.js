export const CHRONICLE_CONTENT = {
  ...
  institute: {
    ...
    mapBody:
      "Each illuminated point marks a teacher-unlocked case. The Archive opens one route at a time.",
    currentCase: "Caribbean · 1493",
    currentTitle: "Case 1.01 — The Atlantic Crossroads",
    currentDescription:
      "Investigate how early Atlantic contact reshaped societies on both sides of the ocean.",
  ...
  case: {
    ...
    centralQuestion:
      "How did early contact among Europe, Africa, and the Americas begin to reshape societies on both sides of the Atlantic?",
    mentor: "Maren Vale",
    mentorRole: "Senior Chronicler · Field Mentor",
    mentorNote:
      "Start with the evidence. The peoples and societies of the Caribbean did not begin with European arrival. Secure each record, then use your Codex to test what it can support.",
...
export const CASE_001_SOURCES = [
  {
    ...
    context:
      "This is a modern secondary-context record. It helps establish that Caribbean societies were organized and longstanding before European arrival. It is not a Taíno-authored primary source.",
  ...
  },
  {
    ...
    date: "1493",
    provenance: "Letter to Rafael Sánchez, written after the first voyage",
    excerpt:
      "“They are so ingenuous and free with all they have, that no one would believe it without seeing it.”",
    context:
      "This excerpt comes from Columbus’s report after his first voyage. It is evidence of a European expedition leader’s observations and goals, not a neutral account of Indigenous life.",
  ...
  },
  {
    ...
    context:
      "This visual source was created years after Columbus’s first voyage. Use it to ask how European geographic knowledge was changing—not to treat it as a direct picture of Caribbean life in 1493.",
    ...
    visual: "map",
    localAsset: "assets/documents/source-waldseemuller-1507.jpg",
  },
];
