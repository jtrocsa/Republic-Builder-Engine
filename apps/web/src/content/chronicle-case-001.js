export const CHRONICLE_CONTENT = {
  ...
  institute: {
    ...
    mapBody: 'Each illuminated point marks a teacher-unlocked case. The Archive opens one route at a time.',
  ...
  case: {
    ...
    mentorNote: 'Start with the evidence. The peoples and societies of the Caribbean did not begin with European arrival. Secure each record, then use your Codex to test what it can support.',
...
export const CASE_001_SOURCES = [
  {
    id: 'taino-context', signalLabel: 'Community record', sourceType: 'Secondary context', title: 'The Caribbean—Island Society', creator: 'Library of Congress exhibition text', date: '1991 exhibition text', provenance: '1492: An Ongoing Voyage, Library of Congress',
    ...
    sourceQuestion: 'What does this record establish about Caribbean societies before contact?',
    citation: 'Library of Congress, “What Came To Be Called ‘America’,” 1492: An Ongoing Voyage, “The Caribbean—Island Society.”',
    sourceUrl: 'https://www.loc.gov/exhibits/1492/america.html', visual: 'context'
  },
  {
    id: 'columbus-letter', signalLabel: 'European letter', sourceType: 'Primary source · Letter', title: 'Letter Reporting on the First Voyage', creator: 'Christopher Columbus', date: '1493', provenance: 'Letter to Rafael Sánchez, written after the first voyage',
    ...
    sourceUrl: 'https://www.loc.gov/item/18018461/', visual: 'letter'
  },
  {
    id: 'waldseemuller-map', signalLabel: 'Atlantic map', sourceType: 'Primary source · Map', title: 'Universalis cosmographia', creator: 'Martin Waldseemüller', date: '1507', provenance: 'Printed world map; Library of Congress Geography and Map Division',
    ...
    sourceQuestion: 'What does this map reveal about the mapmaker’s knowledge and assumptions?',
    ...
    sourceUrl: 'https://www.loc.gov/item/2003626426/', visual: 'map', localAsset: 'assets/documents/source-waldseemuller-1507.jpg'
  }
];
