...
// The "Founding Debate" per-record MCQ content that used to live here as
// FOUNDING_RECORDS (feeding the now-deleted foundingScreen()) was migrated
// onto the quest-type system — its content is fully preserved in
// content/quests/unit-03-quests.js's UNIT_03_ARCHIVE_CHALLENGE_QUESTS entry
// "case-008-archive-ratification-claims" (evidence-organizing), which is now
// Case 1.08's entire mechanic rather than a bespoke ledger screen — the same
// migration already applied to Case 1.02's EXCHANGE_RECORDS/exchangeLedgerScreen().
